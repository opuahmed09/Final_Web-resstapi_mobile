...
public class ExcelReader {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] data = excelReader.getValueByColumn("C:\\Users\\ahmed\\Desktop\\WebAutomationnn\\Generic\\src\\main\\resources\\Book.xls");
        for (int a = 1; a < data.length; a++) {
            System.out.println(data[a]);
        }
        System.out.println("Specific ********");
        String fileReader2 = excelReader.getValueOf("C:\\Users\\ahmed\\Desktop\\WebAutomationnn\\Generic\\src\\main\\resources\\Book.xls", 0, 1);
